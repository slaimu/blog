...
export default (<div id="preview" preview="" debounce="150"><h1><a id="Dillinger_0"></a>Dillinger</h1>
...
<h3><a id="Plugins_70"></a>Plugins</h3>
...
<h3><a id="Development_84"></a>Development</h3>
...
<h4><a id="Building_for_source_107"></a>Building for source</h4>
...
<h3><a id="Docker_116"></a>Docker</h3>
...
<pre><code class="language-sh"><span class="hljs-built_in">cd</span> dillinger
docker build -t joemccann/dillinger:<span class="hljs-variable"></span>
</code></pre>
<p>This will create the dillinger image and pull in the necessary dependencies. Be sure to swap out <code></code> with the actual version of Dillinger.</p>
...
<pre><code class="language-sh">docker run <span class="hljs-operator">-d</span> -p <span class="hljs-number">8000</span>:<span class="hljs-number">8080</span> --restart=<span class="hljs-string">"always"</span> &lt;youruser&gt;/dillinger:<span class="hljs-variable"></span>
</code></pre>
